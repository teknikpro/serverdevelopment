...
{
	$file =  "termometer-depresi.daftaranggota.php";
	$nama_aksi = "Kirim Kode Validasi";
}
else if($aksi=="tes") $file =  "termometer-depresi.tes.php";
else if($aksi=="user") $file =  "termometer-depresi.user.php";
else if($aksi=="hasil") $file =  "termometer-depresi.hasil.php";
else
{
...
elseif(!$_SESSION['userid']) {
	$tpl->display('termometer-depresi.html');
}
else $tpl->display('termometer-depresi.html');
