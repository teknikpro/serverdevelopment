...
if ($aksi == "daftaranggota") {
	$file =  "tes-psikologi.daftaranggota.php";
	$nama_aksi = "Kirim Kode Validasi";
} else if ($aksi == "tes") $file =  "tes-psikologi.tes.php";
else if ($aksi == "teskedua") $file =  "tes-psikologi.teskedua.php";
else if ($aksi == "user") $file =  "tes-psikologi.user.php";
else if ($aksi == "soaljawaban") $file =  "tes-psikologi.soaljawaban.php";
else if ($aksi == "uploadgambar") $file =  "tes-psikologi.uploadgambar.php";
else if ($aksi == "hasil") $file =  "tes-psikologi.hasil.php";
else if ($aksi == "selesai") $file =  "tes-psikologi.selesai.php";
else {
	if (empty($aksi)) $aksi = "daftaranggota";
}
...
if ($aksi == "pay") {
	...
	$tpl->display('tes-psikologii.html');
} else $tpl->display('tes-psikologii.html');
