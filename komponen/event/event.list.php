...
$mysql = "select id,ringkas,nama,create_date,alias,gambar,gambar1,waktu from tbl_$kanal where published='1' order by id desc limit $ord, $judul_per_hlm";
$hasil = sql( $mysql);
...
while ($data =  sql_fetch_data($hasil)) {	
	...
	$datadetail[$id] = array("id"=>$id,"no"=>$i,"nama"=>$nama,"ringkas"=>$ringkas,"tanggal"=>$tanggal,"waktu"=>$waktu,"link"=>$link,"gambar"=>$gambar);
	$i++;
