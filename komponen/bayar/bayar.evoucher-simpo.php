			...
			if ($_GET['fromapps']) {
				...
				$transaction = array(
					"vtweb" => array(
						...
						"finish_redirect_url" => "$fulldomain/bayar/evoucher-simpo/finish/sukses/?fromapps=1",
						"unfinish_redirect_url" => "$fulldomain/bayar/evoucher-simpo/finish/gagal/?fromapps=1",
						"error_redirect_url" => "$fulldomain/bayar/evoucher-simpo/finish/error/?fromapps=1"
					),
				...
				$transaction = array(
					"vtweb" => array(
						//"enabled_payments" => array("$metode"),
						"finish_redirect_url" => "$fulldomain/bayar/evoucher-simpo/finish/sukses/",
						"unfinish_redirect_url" => "$fulldomain/bayar/evoucher-simpo/finish/gagal/",
						"error_redirect_url" => "$fulldomain/bayar/evoucher-simpo/finish/error/"
					),
					'transaction_details' => $transaction_details,
					'customer_details' => $customer_details,
					'item_details' => $item_details,
