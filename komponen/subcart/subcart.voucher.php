		...
		if($hsl) {
			...
			$transaction = array(
				"vtweb" => array (
				  ...
				  "finish_redirect_url" => "$fulldomain/cart/voucher/finish/sukses/",
				  "unfinish_redirect_url" => "$fulldomain/cart/voucher/finish/gagal/",
				  "error_redirect_url" => "$fulldomain/cart/voucher/finish/error/"
				),
