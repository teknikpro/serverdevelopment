...
if($estatus=="1")
{
	...
	{	
		...
		$pesan = "<br />Sorry your reservation is invalid or some mistakes with your payment. Please try to
				  ...
				  <button type=\"button\"  class=\"btnsub_back\" onclick=\"window.location='$fulldomain/cart/pembayaran/$kode1'\">Methode Pembayaran</button>";
	...
	else
	{
		...
		if($signature!=$hash)
		{
			...
			$pesan = "<br />Maaf untuk saat ini transaksi gagal dilakukan atau ada beberapa kesalahan dalam pembayaran. Silahkan ulangi pesanan Anda Kembali. 
					  ...
					  <button type=\"button\"  class=\"btnsub_back\" onclick=\"window.location='$fulldomain/cart/pembayaran/$kodeinvoice'\">Kembali</button>";
			$tpl->assign("salah",$pesan);
