		...
		if($hsl)
		{
			...
			$transaction = array(
				"vtweb" => array (
				  ...
				  "finish_redirect_url" => "$fulldomain/cart/upgrade/finish/sukses/",
				  "unfinish_redirect_url" => "$fulldomain/cart/upgrade/finish/gagal/",
				  "error_redirect_url" => "$fulldomain/cart/upgrade/finish/error/"
				),
