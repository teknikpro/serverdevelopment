...
if ($aksi == "daftaranggota") {
	$file =  "termometer-kecemasan.daftaranggota.php";
	$nama_aksi = "Kirim Kode Validasi";
} else if ($aksi == "tes") $file =  "termometer-kecemasan.tes.php";
else if ($aksi == "user") $file =  "termometer-kecemasan.user.php";
else if ($aksi == "hasil") $file =  "termometer-kecemasan.hasil.php";
else {
...
if ($aksi == "pay") {
	...
	$tpl->display('termometer-kecemasan.html');
} else $tpl->display('termometer-kecemasan.html');
