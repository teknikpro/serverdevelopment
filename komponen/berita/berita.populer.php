<?php
$mysql = "select id,ringkas,nama,create_date,alias,gambar,secid,views from tbl_berita where published='1' order by views desc limit 10";
$hasil = sql($mysql);
...
while ($data = sql_fetch_data($hasil)) {	
		...
		$link = "$fulldomain/berita/read/$secalias/$ids/$alias";
