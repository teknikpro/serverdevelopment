...
$mysql = "select userid,username,userfullname,avatar,konsulsecid,konsulsubid,hargakonsultasi,online,rating,aboutme,judul_simposium from tbl_member where tipe='1' and simposium='5' order by rating asc";
$hasil = sql($mysql);
