...
while ($data =  sql_fetch_data($hasil)) {	
	...
	$datadetail[$id] = array("id"=>$id,"no"=>$i,"nama"=>$nama,"ringkas"=>$ringkas,"tanggal"=>$tanggal,"alias"=>$alias,"link"=>$link,"gambar"=>$gambar,"namasec"=>$namasec,"urlsec"=>"$fulldomain/video/list/$secalias1");
	$i++;
