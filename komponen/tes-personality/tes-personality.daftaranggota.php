...
if (!$salah) {
	...
	$perintah = "select max(userid) as baru from tbl_tes_disc_user";
	$hasil = sql($perintah);
	...
	$query = "insert into tbl_tes_disc_user (userid,userdob,userfullname,useremail,userphonegsm,usergender,usercreateddate,pendidikan,pekerjaan,marriagestatusid,kotaid,propinsiid,is_medis,covid_kondisi,tempat_kerja,is_pasienrshs)
