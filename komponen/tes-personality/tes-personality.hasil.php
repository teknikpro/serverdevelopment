...
// $dataterakhir = sql("SELECT userid FROM tbl_member ORDER BY userid DESC LIMIT 5 ");
// // $dataterakhir = [1433,1663,4547];

// foreach($dataterakhir as $key){
// 	echo var_dump(intval($key['userid']));
// }
// die;
