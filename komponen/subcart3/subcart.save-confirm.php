		...
		elseif( $statustrans== '1')
		{
			...
			if(empty($konfirmasiid))
			{
				...
				if($query)
				{
					...
					Agar segera di tindak lanjuti dan followup informasi diatas dengan cara mengakses sistem ";
					
					sendmail($owner,$support_email,$subject,$message,emailhtml($message));
					...
					$pesanhasil = "Terimakasih telah melakukan konfirmasi. Pembayaran anda akan kami validasi terlebih dahulu. Kami akan
					mengirimkan informasi lanjutan melalui email atau SMS.";
