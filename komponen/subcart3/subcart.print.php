<?php
	...
	{*/
		...
		$sql1	= "select transaksiid, invoiceid, orderid, totaltagihan, pengiriman, pembayaran, userid, namalengkap, alamatpengiriman, warehouseid, voucherid, totaldiskon, 
				totaltagihanafterdiskon, ongkosinfo, ongkoskirim, status, tipe,email, tanggaltransaksi, batastransfer, bank_tujuan from tbl_transaksi where invoiceid='$invoiceid'";
		$hsl1 = sql($sql1);
		...
		$confee2 = substr($orderid,-3,3);
		$tpl->assign("confee2",$confee2);
		...
		$totaltagihanakhir2 		= "Rp. ".number_format($totaltagihanakhir,0,".",".");
		$totaltagihan2	= "Rp. ".number_format($totaltagihan,0,".",".");
		$totaldiskon2 		= "Rp. ".number_format($totaldiskon,0,".",".");
