...
if($_SESSION['orderid'])
{
	...
	if($_SESSION['username'] or ($jenis==1))
	{
		...
		$batastransfer = $datetransfer;
		
		$batastransfer = tanggal($batastransfer);
		...
		{		
			$perintah 	= "update tbl_transaksi set invoiceid='$invoiceid', namalengkap='$userfullname', email='$email', alamatpengiriman='$alamat_kirim', ongkosinfo='$ongkosinfo',propid='$propinsiid',kotaid='$kotaid',kecid='$kecid',
						 ongkoskirim='$ongkoskirim',confee='$confee', pembayaran='$pembayaran', bank_tujuan='$bank', tanggaltransaksi='$tanggal', batastransfer='$datetransfer', 
						 warehouseid='$warehouseid', pesan='$pesan', agen='$pengiriman', namapengirim='$namapengirim', telppengirim='$telppengirim', status='1', userid='$_SESSION[userid]'  
