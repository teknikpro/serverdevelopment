...
if ($aksi == "daftaranggota") {
	$file =  "tes-sekolah.daftaranggota.php";
	$nama_aksi = "Kirim Kode Validasi";
} else if ($aksi == "tes") $file =  "tes-sekolah.tes.php";
else if ($aksi == "user") $file =  "tes-sekolah.user.php";
else if ($aksi == "mencolok") $file =  "tes-sekolah.mencolok.php";
else if ($aksi == "pertanyaan") $file =  "tes-sekolah.pertanyaan.php";
else if ($aksi == "hasil") $file =  "tes-sekolah.hasil.php";
else {
...
if ($aksi == "pay") {
	...
	$tpl->display('tes-sekolah.html');
} else $tpl->display('tes-sekolah.html');
