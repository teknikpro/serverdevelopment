...
{ 
	...
	{ 
		$nama_aksi = "Ubah Password";
	  	$file = "konsultan.gantipassword.php"; 
	}
	elseif($subaksi=="profile") 
	{ 
		$nama_aksi = "Pengaturan Profile";
	  	$file = "konsultan.setting.profile.php"; 
	}
	elseif($subaksi=="avatar") 
	{ 
		$nama_aksi = "Ganti Avatar";
	  	$file = "konsultan.setting.avatar.php"; 
	}
	elseif($subaksi=="tampilan") 
	{ 
		$nama_aksi = "Ganti Gambar Latar Belakang";
	  	$file = "konsultan.setting.tampilan.php"; 
	}
	elseif($subaksi=="privacy") 
	{ 
		$nama_aksi = "Keamanan Privacy";
	  	$file = "konsultan.setting.privacy.php"; 
	}
	elseif($subaksi=="notifikasiemail") 
	{ 
		$nama_aksi = "Notifikasi Email";
	  	$file = "konsultan.setting.notifikasiemail.php"; 
	}
	elseif($subaksi=="getchat") 
	{ 
		$nama_aksi = "Notifikasi Email";
	  	$file = "konsultan.getchat.php"; 
	}
  	else
	{
		$nama_aksi = "Perubahan Profil";
		//$file = "konsultan.setting.php"; 
	}
}
else if($aksi=="notifikasi") { $file =  "konsultan.notifikasi.php"; $nama_aksi = "Notifikasi";}
else if($aksi=="histori") { $file =  "konsultan.histori.php"; $nama_aksi = "Histori Transaksi";}
...
else if(file_exists($lokasiweb."komponen/konsultan/konsultan.$aksi.php")) include("konsultan.$aksi.php");
...
elseif(!$_SESSION['userid']) {
	$tpl->display('konsultan-login.html');
}
else $tpl->display('konsultan.html');
?>