...
$mysql = "select userid,username,userfullname,avatar,konsulsecid,konsulsubid,hargakonsultasi,online,rating,aboutme from tbl_member where tipe='1' and peer='0' and userid='$katid' order by rating desc limit 1";
$hasil = sql( $mysql);
