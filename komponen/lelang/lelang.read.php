...
$sql	= "select kodeproduk, title, content, ringkas, harga,stock,cart, body_dimension, body_weight,  create_date, userid,ispinjam,ispesan, brandid,icon,numviews,vidio from tbl_product_post where status='1' and produkpostid='$produkpostid' and published='1'";
$query	= sql($sql);
