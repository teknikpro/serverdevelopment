		...
		if($hsl)
		{
			...
			$transaction = array(
				"vtweb" => array (
				  ...
				  "finish_redirect_url" => "$fulldomain/cart/paket/finish/sukses/",
				  "unfinish_redirect_url" => "$fulldomain/cart/paket/finish/gagal/",
				  "error_redirect_url" => "$fulldomain/cart/paket/finish/error/"
				),
