...
{
	include("subcart.notification-upgrade.php");
	exit();
}
if(preg_match("/VKDFS/i",$order_id))
{
	include("subcart.notification-voucher.php");
	exit();
}
if(preg_match("/EVDFS/i",$order_id))
{
	include("subcart.notification-evoucher.php");
	exit();
}
if(preg_match("/PVFS/i",$order_id))
{
	include("subcart.notification-paket.php");
	exit();
}
